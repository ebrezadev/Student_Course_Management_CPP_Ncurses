...
void StateCoursesList::formatHandler()
{
	getmaxyx(stdscr, max_rows, max_columns);

	if (!title_window_is_rendered)
	{
		titleWindowRender((char *)"WORKSPACE: COURSES LIST", TITLE_BAR_WIDTH, max_columns - MENU_COLS, 0, MENU_COLS, WORKSPACE_TITLE_BAR_COLOR_ON);
	}
...
void StateCoursesList::mainWindowHandler()
{
...
void StateCoursesList::inputHandler(int input)
{
	switch (input)
	{
	case KEY_UP:
