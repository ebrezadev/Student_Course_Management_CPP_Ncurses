...
StateNotificationPracticalCourseAddDuplicate::StateNotificationPracticalCourseAddDuplicate()
{
...
void StateNotificationPracticalCourseAddDuplicate::formatHandler()
{
...
void StateNotificationPracticalCourseAddDuplicate::mainWindowHandler()
{
	next_state = State_list_t::State_Notification_Practical_Course_Add_Duplicate;
...
void StateNotificationPracticalCourseAddDuplicate::inputHandler(int input)
{
	switch (input)
	{
	case (int)13: // ENTER
