...
StateNotificationTheoreticalCourseAddDuplicate::StateNotificationTheoreticalCourseAddDuplicate()
{
...
void StateNotificationTheoreticalCourseAddDuplicate::formatHandler()
{
...
void StateNotificationTheoreticalCourseAddDuplicate::mainWindowHandler()
{
	next_state = State_list_t::State_Notification_Theoretical_Course_Add_Duplicate;
...
void StateNotificationTheoreticalCourseAddDuplicate::inputHandler(int input)
{
	switch (input)
	{
	case (int)13: // ENTER
