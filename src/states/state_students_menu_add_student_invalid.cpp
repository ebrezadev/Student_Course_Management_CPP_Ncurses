...
StateNotificationStudentAddFail::StateNotificationStudentAddFail()
{
...
void StateNotificationStudentAddFail::formatHandler()
{
...
void StateNotificationStudentAddFail::mainWindowHandler()
{
	next_state = State_list_t::State_Notification_Student_Add_Fail;
...
void StateNotificationStudentAddFail::inputHandler(int input)
{
	switch (input)
	{
	case KEY_UP:
