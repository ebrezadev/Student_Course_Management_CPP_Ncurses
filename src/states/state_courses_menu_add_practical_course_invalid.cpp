...
StateNotificationPracticalCourseAddFail::StateNotificationPracticalCourseAddFail()
{
...
void StateNotificationPracticalCourseAddFail::formatHandler()
{
...
void StateNotificationPracticalCourseAddFail::mainWindowHandler()
{
	next_state = State_list_t::State_Notification_Practical_Course_Add_Fail;
...
void StateNotificationPracticalCourseAddFail::inputHandler(int input)
{
	switch (input)
	{
	case (int)13: // ENTER
